...
- (NSURL *)vcrFileURL
{
    NSString *vcrPath = [NSString stringWithFormat:@"/Users/alexevers/workspace/third-party/beardie/BeardieTests/cassettes/%@-cassette.json", _strategyName];
...
- (NSString *)evaluateScript:(NSString *)script
{
    ...
    NSDictionary *result = [self.tab executeJavascript:@"JSON.parse(document.getElementById('X_Beardie_Chrome_ApplescriptHack').innerText)"];

    [self.tab executeJavascript:@"document.getElementById('X_Beardie_Chrome_ApplescriptHack').remove()"];
