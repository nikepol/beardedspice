...
- (NSURL *)vcrFileURL
{
    NSString *vcrPath = [NSString stringWithFormat:@"/Users/alexevers/workspace/third-party/beardiemusic/BeardieMusicTests/cassettes/%@-cassette.json", _strategyName];
...
- (NSString *)evaluateScript:(NSString *)script
{
    ...
    NSDictionary *result = [self.tab executeJavascript:@"JSON.parse(document.getElementById('X_BeardieMusic_Chrome_ApplescriptHack').innerText)"];

    [self.tab executeJavascript:@"document.getElementById('X_BeardieMusic_Chrome_ApplescriptHack').remove()"];
