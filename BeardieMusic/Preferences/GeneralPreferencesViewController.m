...
NSString *const BeardieMusicAlwaysShowNotification = @"BeardieMusicAlwaysShowNotification";
NSString *const BeardieMusicRemoveHeadphonesAutopause = @"BeardieMusicRemoveHeadphonesAutopause";
NSString *const BeardieMusicUsingAppleRemote = @"BeardieMusicUsingAppleRemote";
NSString *const BeardieMusicLaunchAtLogin = @"BeardieMusicLaunchAtLogin";
NSString *const BeardieMusicUpdateAtLaunch = @"BeardieMusicUpdateAtLaunch";
NSString *const BeardieMusicShowProgress = @"BeardieMusicShowProgress";
NSString *const BeardieMusicCustomVolumeControl = @"BeardieMusicCustomVolumeControl";
...
- (IBAction)toggleLaunchAtStartup:(id)sender{
    ...
    BOOL shouldBeLaunchAtLogin = [[NSUserDefaults standardUserDefaults] boolForKey:BeardieMusicLaunchAtLogin];
...
- (void)repairLaunchAtLogin{
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_HIGH, 0), ^{
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            [[NSUserDefaults standardUserDefaults] setBool:val forKey:BeardieMusicLaunchAtLogin];
