...
NSString *const BeardieMusicActiveControllers = @"BeardieMusicActiveControllers";
NSString *const BeardieMusicActiveNativeAppControllers = @"BeardieMusicActiveNativeAppControllers";
NSString *const BeardieMusicImportExportLastDirectory = @"BeardieMusicImportExportLastDirectory";
        ...
        @autoreleasepool {
            ...
            if (strategy) {
                ...
                openPanel.title = NSLocalizedString(
                                                    @"BeardieMusic - Choose a folder for exporting",
                ...
                [openPanel beginWithCompletionHandler:^(NSInteger result) {
                    ...
                    if (result == NSFileHandlingPanelOKButton) {
                        ...
                        [[NSUserDefaults standardUserDefaults]
                         ...
                         forKey:BeardieMusicImportExportLastDirectory];
...
- (IBAction)clickImport:(id)sender {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        @autoreleasepool {
            ...
            openPanel.allowsMultipleSelection = NO;
            openPanel.title =
            NSLocalizedString(@"BeardieMusic - Choose a file for importing",
                              @"(GeneralPreferencesViewController) In "
                              @"preferences, strategies list. Title of the "
...
- (void)updateMediaStrategyRegistry:(id)sender {
    ...
    if ([obj.representationObject isKindOfClass:[BSMediaStrategy class]]) {
        ...
        [[NSUserDefaults standardUserDefaults]
         ...
         forKey:BeardieMusicActiveControllers];
    } else {
        // Native
        if (enabled) {
        ...
        [[NSUserDefaults standardUserDefaults]
         ...
         forKey:BeardieMusicActiveNativeAppControllers];
...
- (void)loadMediaControllerObjects{
    ...
    if (theArray.count) {
        ...
        userNativeApps = [NSMutableDictionary dictionaryWithDictionary:[[NSUserDefaults standardUserDefaults] dictionaryForKey:BeardieMusicActiveNativeAppControllers]];
    }
    ...
    if (theArray.count) {
        ...
        userStrategies = [NSMutableDictionary dictionaryWithDictionary:[[NSUserDefaults standardUserDefaults] dictionaryForKey:BeardieMusicActiveControllers]];
    }
...
- (NSURL *)importExportDirectoryForCustomStrategy {
    ...
    NSString *path = [[NSUserDefaults standardUserDefaults]
                      stringForKey:BeardieMusicImportExportLastDirectory];
    if (path) {
