...
#import "BeardieMusicHostAppProtocol.h"
...
- (id)init{
    ...
    if (self == bscSingleton) {
        ...
        if (self) {
            ...
            workingQueue = dispatch_queue_create("BeardieMusicControllerService", DISPATCH_QUEUE_SERIAL);
    ...
    dispatch_async(workingQueue, ^{
        @autoreleasepool {
            ...
            if (_enabled) {
                ...
                MASShortcut *shortcut = _shortcuts[BeardieMusicPlayPauseShortcut];
                if (shortcut){
                ...
                shortcut = _shortcuts[BeardieMusicNextTrackShortcut];
                if (shortcut){
                    [[BSCShortcutMonitor sharedMonitor] registerShortcut:shortcut withAction:^{
                ...
                shortcut = _shortcuts[BeardieMusicPreviousTrackShortcut];
                if (shortcut){
                    [[BSCShortcutMonitor sharedMonitor] registerShortcut:shortcut withAction:^{
                ...
                shortcut = _shortcuts[BeardieMusicActiveTabShortcut];
                if (shortcut){
                    [[BSCShortcutMonitor sharedMonitor] registerShortcut:shortcut withAction:^{
                ...
                shortcut = _shortcuts[BeardieMusicFavoriteShortcut];
                if (shortcut){
                    [[BSCShortcutMonitor sharedMonitor] registerShortcut:shortcut withAction:^{
                ...
                shortcut = _shortcuts[BeardieMusicNotificationShortcut];
                if (shortcut){
                    [[BSCShortcutMonitor sharedMonitor] registerShortcut:shortcut withAction:^{
                ...
                shortcut = _shortcuts[BeardieMusicActivatePlayingTabShortcut];
                if (shortcut){
                    [[BSCShortcutMonitor sharedMonitor] registerShortcut:shortcut withAction:^{
                ...
                shortcut = _shortcuts[BeardieMusicPlayerNextShortcut];
                if (shortcut){
                    [[BSCShortcutMonitor sharedMonitor] registerShortcut:shortcut withAction:^{
                ...
                shortcut = _shortcuts[BeardieMusicPlayerPreviousShortcut];
                if (shortcut){
                    [[BSCShortcutMonitor sharedMonitor] registerShortcut:shortcut withAction:^{
    ...
    dispatch_async(workingQueue, ^{
        @autoreleasepool {
            ...
            for (NSXPCConnection *conn in _connections) {
                ...
                id<BeardieMusicHostAppProtocol, NSObject> obj = [conn remoteObjectProxy];
