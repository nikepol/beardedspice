...
- (id)init{
    ...
    if (self == bscSingleton) {
        ...
        if (self) {
            ...
            workingQueue = dispatch_queue_create("BeardieControllerService", DISPATCH_QUEUE_SERIAL);
    ...
    dispatch_async(workingQueue, ^{
        @autoreleasepool {
            ...
            if (_enabled) {
                ...
                MASShortcut *shortcut = _shortcuts[BeardiePlayPauseShortcut];
                if (shortcut){
                ...
                shortcut = _shortcuts[BeardieNextTrackShortcut];
                if (shortcut){
                    [[BSCShortcutMonitor sharedMonitor] registerShortcut:shortcut withAction:^{
                ...
                shortcut = _shortcuts[BeardiePreviousTrackShortcut];
                if (shortcut){
                    [[BSCShortcutMonitor sharedMonitor] registerShortcut:shortcut withAction:^{
                ...
                shortcut = _shortcuts[BeardieActiveTabShortcut];
                if (shortcut){
                    [[BSCShortcutMonitor sharedMonitor] registerShortcut:shortcut withAction:^{
                ...
                shortcut = _shortcuts[BeardieFavoriteShortcut];
                if (shortcut){
                    [[BSCShortcutMonitor sharedMonitor] registerShortcut:shortcut withAction:^{
                ...
                shortcut = _shortcuts[BeardieNotificationShortcut];
                if (shortcut){
                    [[BSCShortcutMonitor sharedMonitor] registerShortcut:shortcut withAction:^{
                ...
                shortcut = _shortcuts[BeardieActivatePlayingTabShortcut];
                if (shortcut){
                    [[BSCShortcutMonitor sharedMonitor] registerShortcut:shortcut withAction:^{
                ...
                shortcut = _shortcuts[BeardiePlayerNextShortcut];
                if (shortcut){
                    [[BSCShortcutMonitor sharedMonitor] registerShortcut:shortcut withAction:^{
                ...
                shortcut = _shortcuts[BeardiePlayerPreviousShortcut];
                if (shortcut){
                    [[BSCShortcutMonitor sharedMonitor] registerShortcut:shortcut withAction:^{
    ...
    dispatch_async(workingQueue, ^{
        @autoreleasepool {
            ...
            for (NSXPCConnection *conn in _connections) {
                ...
                id<BeardieHostAppProtocol, NSObject> obj = [conn remoteObjectProxy];
