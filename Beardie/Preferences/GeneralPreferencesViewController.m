...
NSString *const BeardieAlwaysShowNotification = @"BeardieAlwaysShowNotification";
NSString *const BeardieRemoveHeadphonesAutopause = @"BeardieRemoveHeadphonesAutopause";
NSString *const BeardieUsingAppleRemote = @"BeardieUsingAppleRemote";
NSString *const BeardieLaunchAtLogin = @"BeardieLaunchAtLogin";
NSString *const BeardieUpdateAtLaunch = @"BeardieUpdateAtLaunch";
NSString *const BeardieShowProgress = @"BeardieShowProgress";
NSString *const BeardieCustomVolumeControl = @"BeardieCustomVolumeControl";
...
- (IBAction)toggleLaunchAtStartup:(id)sender{
    ...
    BOOL shouldBeLaunchAtLogin = [[NSUserDefaults standardUserDefaults] boolForKey:BeardieLaunchAtLogin];
...
- (void)repairLaunchAtLogin{
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_HIGH, 0), ^{
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            [[NSUserDefaults standardUserDefaults] setBool:val forKey:BeardieLaunchAtLogin];
