...
NSString *const BeardieActiveControllers = @"BeardieActiveControllers";
NSString *const BeardieActiveNativeAppControllers = @"BeardieActiveNativeAppControllers";
NSString *const BeardieImportExportLastDirectory = @"BeardieImportExportLastDirectory";
        ...
        @autoreleasepool {
            ...
            if (strategy) {
                ...
                openPanel.title = NSLocalizedString(
                                                    @"Beardie - Choose a folder for exporting",
                ...
                [openPanel beginWithCompletionHandler:^(NSInteger result) {
                    ...
                    if (result == NSFileHandlingPanelOKButton) {
                        ...
                        [[NSUserDefaults standardUserDefaults]
                         ...
                         forKey:BeardieImportExportLastDirectory];
...
- (IBAction)clickImport:(id)sender {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        @autoreleasepool {
            ...
            openPanel.allowsMultipleSelection = NO;
            openPanel.title =
            NSLocalizedString(@"Beardie - Choose a file for importing",
                              @"(GeneralPreferencesViewController) In "
                              @"preferences, strategies list. Title of the "
...
- (void)updateMediaStrategyRegistry:(id)sender {
    ...
    if ([obj.representationObject isKindOfClass:[BSMediaStrategy class]]) {
        ...
        [[NSUserDefaults standardUserDefaults]
         ...
         forKey:BeardieActiveControllers];
    } else {
        // Native
        if (enabled) {
        ...
        [[NSUserDefaults standardUserDefaults]
         ...
         forKey:BeardieActiveNativeAppControllers];
...
- (void)loadMediaControllerObjects{
    ...
    if (theArray.count) {
        ...
        userNativeApps = [NSMutableDictionary dictionaryWithDictionary:[[NSUserDefaults standardUserDefaults] dictionaryForKey:BeardieActiveNativeAppControllers]];
    }
    ...
    if (theArray.count) {
        ...
        userStrategies = [NSMutableDictionary dictionaryWithDictionary:[[NSUserDefaults standardUserDefaults] dictionaryForKey:BeardieActiveControllers]];
    }
...
- (NSURL *)importExportDirectoryForCustomStrategy {
    ...
    NSString *path = [[NSUserDefaults standardUserDefaults]
                      stringForKey:BeardieImportExportLastDirectory];
    if (path) {
